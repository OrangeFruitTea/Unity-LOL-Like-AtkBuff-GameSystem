...
{
    /// <summary>
    /// 按 <see cref="UnitArchetype"/> 生成时写入 <see cref="EntityBaseData.AtkDistance"/> 的表格式基准（如 100/250/350；读取时由 <see cref="Gameplay.Combat.Targeting.CombatTargetingRange.StoredAttackDistanceToWorldDistance"/> 换世界单位）。<br/>
